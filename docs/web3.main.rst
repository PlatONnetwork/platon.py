...
.. _JSON-RPC spec: https://github.com/platonnetwork/wiki/wiki/JSON-RPC#hex-value-encoding
...
.. py:method:: Web3.toVon(value, currency)
...
.. py:method:: Web3.fromVon(value, currency)

    Returns the value in von converted to the given currency. The value is returned
    as a ``Decimal`` to ensure precision down to the von.


    .. code-block:: python

        >>> Web3.fromVon(1000000000000000000, 'ether')
        Decimal('1')
...
.. py:method:: Web3.isChecksumAddress(value)
    ...
    Returns ``True`` if the value is a valid bech32 address
...
.. py:method:: Web3.toChecksumAddress(value)
    ...
    Returns the given address with an bech32.
...
.. _EIP55: https://github.com/platonnetwork/EIPs/issues/55
...
.. py:classmethod:: Web3.solidityKeccak(abi_types, value)
    ...
    .. code-block:: python
        ...
        >>> Web3.solidityKeccak(['address'], ["platonfoundation.platon"])
