...
class ExactLengthBytesEncoder(encoding.BaseEncoder):
    # TODO: move this to platon-abi once the api is stabilized
    is_big_endian = False
    value_bit_size = None
    data_byte_size = None
...
def build_default_registry() -> ABIRegistry:
    # We make a copy here just to make sure that platon-abi's default registry is not
