...
from platon_utils.hexadecimal import (
    encode_hex,
)
...
def validate_address(value: Any) -> None:
    ...
    if not is_bech32_address(value):
        raise InvalidAddress(
            "platon.py only accepts bech32 addresses. "
            "If your address is a hex address, "
            "use Web3.toBech32Address(you_address) to translate your address."
        )
