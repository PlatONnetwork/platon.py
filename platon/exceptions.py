...
class InvalidAddress(ValueError):
    """
    The supplied address does not have a valid bech32
    """
    pass
...
class NameNotFound(ValueError):
    """
    Raised when a caller provides an Platon Name Service name that
...
class InvalidParityMode(TypeError, ValueError):
    ...
    """
    Raised when platon.parity.set_mode() is called with no or invalid args
    """
    pass
