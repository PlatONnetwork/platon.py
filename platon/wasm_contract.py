...
from platon._utils.contracts import (
    encode_abi,
...
class ContractEvents:
    ...
    .. code-block:: python
        ...
        >>> mycontract.events
        <platon.contract.ContractEvents object at 0x108afde10>
    ...
    .. code-block:: python
        ...
        <class 'platon._utils.datatypes.LogAnonymous'>
        ...
...
class Contract:
    ...
    :meth:`platon.platon.Platon.contract` that takes compiled Solidity contract
    ...
    * Deploy a new wasm contract using :py:meth:`Contract.constructor.transact()`
    ...
    def __init__(self, address: Optional[Bech32Address] = None) -> None:
        ...
        if self.web3 is None:
            raise AttributeError(
                ...
                '`platon.contract` interface to create your contract class.'
            )
    ...
    def get_function_by_selector(self, selector: Union[bytes, int, HexStr]) -> 'ContractFunction':
        def callable_check(fn_abi: ABIFunction) -> bool:
            ...
            return encode_hex(function_abi_to_4byte_selector(fn_abi)) == to_4byte_hex(selector)  # type: ignore
...
class ContractConstructor:
    ...
    def estimate_gas(
        ...
        if self.web3.platon.default_account is not empty:
            ...
            estimate_gas_transaction.setdefault('from', self.web3.platon.default_account)  # type: ignore

        estimate_gas_transaction['data'] = self.data_in_transaction

        return self.web3.platon.estimate_gas(
    ...
    def transact(self, transaction: Optional[TxParams] = None) -> HexBytes:
        ...
        if self.web3.platon.default_account is not empty:
            # type ignored b/c check prevents an empty default_account
            transact_transaction.setdefault('from', self.web3.platon.default_account)  # type: ignore
    ...
    def build_transaction(self, transaction: Optional[TxParams] = None) -> TxParams:
        ...
        if self.web3.platon.default_account is not empty:
            # type ignored b/c check prevents an empty default_account
            built_transaction.setdefault('from', self.web3.platon.default_account)  # type: ignore
...
class ConciseContract:
    ...
    > contract.withdraw(amount, transact={'from': platon.accounts[1], 'gas': 100000, ...})
...
def _none_addr(datatype: str, data: Bech32Address) -> Tuple[str, Optional[Bech32Address]]:
...
class ContractFunction:
    ...
    def call(
        ...
        .. code-block:: python
            ...
            ContractFactory = w3.platon.contract(
        ...
        :param transaction: Dictionary of transaction info for platon interface
...
class ContractEvent:
    ...
    def create_filter(
            ...
            address: Optional[Bech32Address] = None,
        ...
        filter_builder.address = cast(Bech32Address, event_filter_params.get('address'))
    ...
    def get_logs(self,
        ...
        the Platon node might be overloaded and timeout
        ...
        .. code-block:: python
            ...
            from = max(mycontract.platon.platon.block_number - 10, 1)
            to = mycontract.platon.platon.block_number
        ...
        See also: :func:`platon.middleware.filter.local_filter_middleware`.
        ...
        # Call JSON-RPC API
        logs = self.web3.platon.get_logs(event_filter_params)
...
class ContractCaller:
    ...
    > contract.caller({'from': platon.accounts[1], 'gas': 100000, ...}).add(2, 3)
    is equivalent to this call in the classic contract:
    > contract.functions.add(2, 3).call({'from': platon.accounts[1], 'gas': 100000, ...})
...
def parse_block_identifier(web3: 'Web3', block_identifier: BlockIdentifier) -> BlockIdentifier:
    if isinstance(block_identifier, int):
        ...
        return web3.platon.get_block(block_identifier)['number']
    else:
...
def parse_block_identifier_int(web3: 'Web3', block_identifier_int: int) -> BlockNumber:
    if block_identifier_int >= 0:
        ...
        last_block = web3.platon.get_block('latest')['number']
...
def transact_with_contract_function(
    ...
    txn_hash = web3.platon.send_transaction(transact_transaction)
    return txn_hash
...
def estimate_gas_for_function(
    ...
    return web3.platon.estimate_gas(estimate_transaction, block_identifier)
