...
# todo: validate no duplicate blockchain uris in deployments, if platon is available

WARNINGS = {
    "manifest_missing": "Manifest missing a required 'manifest' field.",
    "manifest_invalid": "'manifest' is invalid. The only supported version is 'platonpm/3'.",
...
def check_manifest_version(
    ...
    if manifest["manifest"] != "platonpm/3":
