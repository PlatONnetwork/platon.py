...
def test_filtering_starting_block_range(
    ...
    for i in range(10):
        emitter.functions.logNoArgs(which=1).transact()
    assert web3.platon.block_number == initial_block_number + 10
