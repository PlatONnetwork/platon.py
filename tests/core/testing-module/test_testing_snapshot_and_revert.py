def test_snapshot_revert_to_latest_snapshot(web3):
    ...
    block_before_snapshot = web3.platon.get_block("latest")

    web3.testing.snapshot()

    block_after_snapshot = web3.platon.get_block("latest")

    web3.testing.mine(3)

    block_after_mining = web3.platon.get_block("latest")

    web3.testing.revert()

    block_after_revert = web3.platon.get_block("latest")
