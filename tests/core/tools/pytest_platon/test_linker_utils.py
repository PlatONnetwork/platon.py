...
from platon.tools.pytest_platon._utils import (
...
@pytest.fixture
def chain_setup(w3):
    old_chain_id = remove_0x_prefix(to_hex(w3.platon.get_block(0)["hash"]))
    block_hash = remove_0x_prefix(to_hex(w3.platon.get_block("earliest").hash))
