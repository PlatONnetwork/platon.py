...
def ens_setup():
    w3 = Web3(PlatonTesterProvider(PlatonTester()))
    ...
    reverse_tld_namehash = bytes32(0xa097f6721ce401e757d1223a763fef49b8b5f90bb18567ddb86fd205dff71d34)
    ...
    platon_registrar = deploy(
        w3,
        ETHRegistrarFactory,
        ens_key,
        args=[ens_contract.address, platon_namehash, 1],
    )
