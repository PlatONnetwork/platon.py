...
class GoPlatonTest(Web3ModuleTest):
    def _check_web3_clientVersion(self, client_version):
        assert client_version.startswith('Gplaton/')


class GoPlatonPlatonModuleTest(PlatonModuleTest):
    @pytest.mark.xfail(reason='platon_signTypedData has not been released in gplaton')
    ...
    @pytest.mark.xfail(reason='platon_protocolVersion was removed in Gplaton 1.10.0')
