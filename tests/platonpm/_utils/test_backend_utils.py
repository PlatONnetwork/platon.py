...
from platonpm._utils.backend import (
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("erc1319://packages.zeppelinos.platon:1/erc20?version=1.0.0", ()),
    ),
)
...
@pytest.mark.parametrize(
    "uri,backends",
    (
        ("erc1319://packages.zeppelinos.platon:1/erc20?version=1.0.0", (RegistryURIBackend,)),
        ("ipfs://QmTKB75Y73zhNbD3Y73xeXGjYrZHmaXXNxoZqGCagu7r8u/", ()),
    ),
)
@pytest.mark.skipif('WEB3_INFURA_PROJECT_ID' not in os.environ, reason='Infura API key unavailable')
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "erc1128://packages.zeppelinos.platon:1/erc20/v1.0.0",
        # swarm
        ...
        # internet
        "http://github.com/platonpm/platonpm-spec/examples/owned/1.0.0.json#content_hash",
        "https://github.com/platonpm/platonpm-spec/examples/owned/1.0.0.json#content_hash",
    ),
)
@pytest.mark.skipif('WEB3_INFURA_PROJECT_ID' not in os.environ, reason='Infura API key unavailable')
