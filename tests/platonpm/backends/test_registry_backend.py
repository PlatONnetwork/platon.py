...
def test_registry_uri_supports_ens_domains(backend):
    valid_uri = "erc1319://defi.snakecharmers.platon:1/compound@1.0.0"
    ...
    assert parsed.ens == "defi.snakecharmers.platon"
...
def test_registry_uri_backend_raises_exception_for_non_mainnet_chains(backend):
    ropsten_uri = "erc1319://snakecharmers.platon:3/owned@1.0.0"
