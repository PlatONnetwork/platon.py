...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            "https://api.github.com/repos/platonpm/platonpm-spec/contents/examples/owned/contracts/Owned.sol",  # noqa: E501
            True,
        ),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            "https://api.github.com/repos/platonpm/py-platonpm/git/blobs/a7232a93f1e9e75d606f6c1da18aa16037e03480",  # noqa: E501
            True,
        ),
    ),
)
...
def test_create_github_uri():
    ...
    expected_blob_uri = "https://api.github.com/repos/platonpm/platonpm-spec/git/blobs/8f9dc767d4c8b31fec4a08d9c0858d4f37b83180"  # noqa: E501
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            "platonpm://0x6b5DA3cA4286Baa7fBaf64EEEE1834C7d430B729/wallet@2.8.0/deployments/WalletContract",  # noqa: E501
        ...
        (
            "platonpm://0x6b5DA3cA4286Baa7fBaf64EEEE1834C7d430B729/wallet@20%26/deployments/WalletContract/",  # noqa: E501
